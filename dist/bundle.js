...
var _arrowFn = __webpack_require__(118);

var _arrowFn2 = _interopRequireDefault(_arrowFn);

var _Person = __webpack_require__(116);
...
var _literals = __webpack_require__(122);

var _literals2 = _interopRequireDefault(_literals);

var _destructuring = __webpack_require__(120);

var _destructuring2 = _interopRequireDefault(_destructuring);

var _module = __webpack_require__(123);

var addition = _interopRequireWildcard(_module);

var _arrayFrom = __webpack_require__(117);

var _arrayFrom2 = _interopRequireDefault(_arrayFrom);

var _promises = __webpack_require__(124);

var _promises2 = _interopRequireDefault(_promises);

__webpack_require__(85);

var _generator = __webpack_require__(121);
...
var person = new _Person2.default('Sam', 18);
...
_arrowFn2.default.receive();
(0, _default2.default)("default value hi");
var first = [5, 8, 9];
alert(_literals2.default);
alert("...对象展开运算符 " + _spread2.default.apply(undefined, first));
...
console.log('arrP ' + (products instanceof Array));
...
var deliveryBoy = {
	...
	receive: function receive() {
		var that = this;
		return this.handleMessage("deliveryBoy,hello, ", function (message) {
			return console.log(message + that.name);
		});
	}
};
...
var _generateObj = generateObj(),
    name = _generateObj.name,
    state = _generateObj.state;
//也可以使用命名的方式


var _generateObj2 = generateObj(),
    myColor = _generateObj2.color,
    myCity = _generateObj2.state;
...
var _marked = [generator, graph].map(regeneratorRuntime.mark);
...
function graph() {
	var x, y;
	return regeneratorRuntime.wrap(function graph$(_context2) {
		while (1) {
...
//greeter.next();
var next = greeter.next().value;
console.log('are: ' + next);
//greeter.next();
var done = greeter.next().value;
...
var _templateObject = _taggedTemplateLiteral(["It's ", "  I'am ", ""], ["It's ", "  I'am ", ""]);
...
d.then(function (data) {
	...
	return console.error('new error meg: ', error);
});
...
var addThreeNum = function addThreeNum(a, b, c) {
  return a + b + c;
};

exports.default = addThreeNum;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(114), __webpack_require__(307)))
